...
Partial Class Presentation_CMS_Article_Edit_Article
    ...
    Protected Sub btn_news_edit_Click(ByVal sender As Object, ByVal e As System.EventArgs) Handles btn_news_edit.Click
        ...
        Check = BLL.Update_Article(txt_title_news_edit.Text, txt_matnkotah_news_edit.Value, FCK_News_edit.Value, E_, Session("username"), cmb_category_edit.SelectedValue, Session("id_article"))
        Select Case Check
            Case 0
    ...
    Protected Sub Edit_News(ByVal sender As Object, ByVal e As CommandEventArgs)
        ...
        Try
            Session("id_article") = e.CommandArgument
    ...
    Protected Sub Page_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        Title = "پنل مدیریت سایت -  ویرایش مقالات"
